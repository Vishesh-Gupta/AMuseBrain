...
def drawArena():
    ...
    draw.rect(DISPLAYSURF, WHITE, ((0,0),(WINDOWWIDTH,WINDOWHEIGHT)), LINETHICKNESS*2)
    #Draw centre line
    draw.line(DISPLAYSURF, WHITE, ((WINDOWWIDTH//2),0),((WINDOWWIDTH//2),WINDOWHEIGHT), (LINETHICKNESS//4))
...
def drawPaddle(paddle):
    ...
    #Draws paddle
    draw.rect(DISPLAYSURF, WHITE, paddle)
...
def main():
    ...
    BASICFONTSIZE = 20
    BASICFONT = font.SysFont("Arial",BASICFONTSIZE)
